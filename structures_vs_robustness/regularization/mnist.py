...
def build_network(x, l1_units, l2_units, l3_units):
    ...
    return z3, y_, weights # logits and probilities

def calc_loss(z3, y, weights):
    ...
    reg_constant = 0.001
    l2_loss = reg_constant * (tf.nn.l2_loss(weights["w1"]) + 
...
def create_mnist_model():
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, './tmp/l2_regularized_mnist_model', global_step=8)
